...
@section("content")
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url('{{asset('frontend/images/banner.jpg')}}');">
			...
			<p>Entrust your health our doctors</p>
			  ...
			  <a href="#" class="banner-btn">Book an Appointment</a>
            </div>
          </div> 
   ...
   <div class="carousel-item" style="background-image: url('{{asset('frontend/images/banner.jpg')}}')">
	...
	<div class="container-fluid">
	  ...
	  <a href="" class="bbBox-btn">Find Now</a>
	  </div>
	  </div>
...
<div class="col-lg-3 p-0">
	  ...
	  <p>Praesent magna ipsumt sit amet iacu lis sit amet lacinia et turpis.</p>
	  <a href="" class="bbBox-btn">Book Now</a>
	  </div>
	  </div>
...
<div class="col-lg-3 p-0">
	  ...
	  <h4>Top Doctors</h4>
	  <p>Praesent magna ipsumt sit amet iacu lis sit amet lacinia et turpis.</p>
	  <a href="" class="bbBox-btn">Explore Now</a>
	  </div>
	  </div>	  
	  </div>
      </div>
	...
	<div class="container">
	  ...
	  <img src="{{asset('frontend/images/wel-pic.jpg')}}" class="img-fluid">
		...
		<p>Maecenas felis neque, tempor et lectus sed, ultricies ullamcorper tortor. Mauris sem sapien, ultrices ac volutpat in, malesuada id libero. Maecenas sollicitudin aliquet ipsum, a tempus sem suscipit sed. Integer ultricies vestibulum ultrices. Aliquam eget augue ante. Morbi ac sem et felis placerat dignissim.</p>
		<p>Aliquam ipsum tellus, varr iohus, auctor pntdfdfesque libero. Vestibulum ultricies, neque inasd dfsae elementum ultricies, ex feu giat lacus, sagittis faucibus mi gthddui at purus dis gnissim feugiat. </p>
		<a href="#" class="rm-btn">About More</a>
		</div>
...
<section id="experts-section">
	...
	<p class="head-caption">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form. </p>
		</div>
	</div>
	...
	<div class="row justify-content-center">
		...
		<img src="{{asset('frontend/images/exp-pic1.jpg')}}" class="img-fluid">
		</div>
	...
	<p class="head-caption">Fusce ultricies blandit odio, at dictum libero posuere sed. Phasellus vitae metus id dolor consequat consequat.</p>
		</div>
	</div>
...
<section id="bookapp-section">
  ...
  <div class="media-body">
    ...
    <p>Don’t hasitate to contact us.</p>
		...
		<div class="col-lg-3">
		<a href="" class="book-btn">Book An Appointment </a>
		</div>
		</div>
		</div>
	</section>
	...
	<p class="head-caption">Fusce ultricies blandit odio, at dictum libero posuere sed. Phasellus vitae metus id dolor consequat consequat.</p>
	  ...
	  <div class="row">
        ...
        <div id="owl-testimonial" class="owl-carousel owl-theme">     
          <div class="item">
<a class="youtube-link" youtubeid="IcVJ-R6RlM4"> <img src="{{asset('frontend/images/video-bg1.jpg')}}" class="img-fluid"> <span class="playbtn-img"><img src="{{asset('frontend/images/play-btn.png')}}"></span></a> 
		  </div>
		  <div class="item">
<a class="youtube-link" youtubeid="IcVJ-R6RlM4"> <img src="{{asset('frontend/images/video-bg2.jpg')}}" class="img-fluid"> <span class="playbtn-img"><img src="{{asset('frontend/images/play-btn.png')}}"></span></a> 
		  </div>
		  <div class="item">
<a class="youtube-link" youtubeid="IcVJ-R6RlM4"> <img src="{{asset('frontend/images/video-bg3.jpg')}}" class="img-fluid"> <span class="playbtn-img"><img src="{{asset('frontend/images/play-btn.png')}}"></span></a> 
		  </div>
		  <div class="item">
<a class="youtube-link" youtubeid="IcVJ-R6RlM4"> <img src="{{asset('frontend/images/video-bg1.jpg')}}" class="img-fluid"> <span class="playbtn-img"><img src="{{asset('frontend/images/play-btn.png')}}"></span></a> 
		  </div>
...
<div class="row justify-content-center mb-5">
	...
	<img src="{{asset('frontend/images/blog-pic1.jpg')}}" class="img-fluid" alt="...">
	<ul class="blog-list">
	<li class="blog-date"><a href=""><i class="fa fa-calendar" aria-hidden="true"></i> Jun 03, 2020</a></li>
	<li class="blog-category"><a href=""><i class="fa fa-folder-open" aria-hidden="true"></i> Heath Care</a></li>
	</ul>
